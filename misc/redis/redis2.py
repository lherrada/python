...
print "=" * 20
r_server.rpush('list1','Erika de Herrada')
print 'at pos 1 of our list is: %s'% r_server.lindex('list1',2) #with lindex we query redis to tell us which element is at pos 1 of our list
